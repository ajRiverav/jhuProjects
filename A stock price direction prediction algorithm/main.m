...
header = ['trainFcn,combo,neurons,threshold,AUC,FalseAlarmsRate,TruePositiveRate\n'];
...
% using the Resilient Backprop algorithm and 10 neurons in 
% a single hidden layer. Later, the logs will be evaluated
% and the best architecture will be chosen. 
